...
import (
	adawolfs_com_v1 "github.com/adawolfs/database-controller/pkg/apis/adawolfs.com/v1"
...
var databasesResource = schema.GroupVersionResource{Group: "adawolfs.com", Version: "v1", Resource: "databases"}

var databasesKind = schema.GroupVersionKind{Group: "adawolfs.com", Version: "v1", Kind: "Database"}

// Get takes name of the database, and returns the corresponding database object, and an error if there is any.
func (c *FakeDatabases) Get(name string, options v1.GetOptions) (result *adawolfs_com_v1.Database, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(databasesResource, c.ns, name), &adawolfs_com_v1.Database{})
...
func (c *FakeDatabases) List(opts v1.ListOptions) (result *adawolfs_com_v1.DatabaseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(databasesResource, databasesKind, c.ns, opts), &adawolfs_com_v1.DatabaseList{})
	...
	list := &adawolfs_com_v1.DatabaseList{}
	for _, item := range obj.(*adawolfs_com_v1.DatabaseList).Items {
...
func (c *FakeDatabases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(databasesResource, c.ns, name), &adawolfs_com_v1.Database{})
...
func (c *FakeDatabases) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &adawolfs_com_v1.DatabaseList{})
	return err
}

// Patch applies the patch and returns the patched database.
func (c *FakeDatabases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *adawolfs_com_v1.Database, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(databasesResource, c.ns, name, data, subresources...), &adawolfs_com_v1.Database{})
