...
import (
	...
	versioned "github.com/adawolfs/database-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/adawolfs/database-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/adawolfs/database-controller/pkg/client/listers/adawolfs.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.AdawolfsV1().Databases(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AdawolfsV1().Databases(namespace).Watch(options)
			},
		},
		&adawolfs_com_v1.Database{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&adawolfs_com_v1.Database{}, f.defaultInformer)
}
